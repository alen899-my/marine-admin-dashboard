  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      route: {
        ...
        via: formData.via,
        totalDistance: formData.totalDistance ? Number(formData.totalDistance) : 0,
      },
      charter: {
  ...
  return (
    <>
      ...
      />
                ...
                <div>
                  <Label>Voyage Number <span className="text-red-500">*</span></Label>
                  <Input
                    name="voyageNo"
            ...
            <ComponentCard title="Route Details">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <Label>Load Port <span className="text-red-500">*</span></Label>
                  <Input
                    name="loadPort"
                  ...
                  />
                  {errors.loadPort && <p className="text-xs text-red-500 mt-1">{errors.loadPort}</p>}
                </div>
                <div>
                  <Label>Discharge Port <span className="text-red-500">*</span></Label>
                  <Input
                    name="dischargePort"
                  ...
                  />
                  {errors.dischargePort && <p className="text-xs text-red-500 mt-1">{errors.dischargePort}</p>}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(_, dateStr) => handleDateChange("charterPartyDate", dateStr)}
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(_, dateStr) => handleDateChange("laycanStart", dateStr)}
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(_, dateStr) => handleDateChange("laycanEnd", dateStr)}
