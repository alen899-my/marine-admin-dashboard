...
<div className="flex items-center justify-end w-full gap-3 mt-6 pt-4 border-t border-gray-100 dark:border-white/5 shrink-0">
  <Button 
    size="sm" 
    variant="outline" 
    onClick={onClose} 
  ...
  {isReadOnly && can("zip.download") && (
    <>
      {/* ZIP Download Button - Uses isZipping */}
      <Button
        size="sm"
        variant="primary"
      ...
      {/* Share ZIP Button - Uses isSharing */}
      <Button
        size="sm"
        variant="outline"
        className="border-slate-200 text-slate-700 bg-white hover:bg-slate-50 dark:bg-slate-800 dark:border-white/10 dark:text-gray-300 shadow-sm transition-all active:scale-95"
