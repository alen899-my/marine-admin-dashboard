...
export default function UserMetaCard() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          email: data.email || "",
          phone: data.phone || "",
          roleName: data.role?.name || "Team Member", // Display Role Name
        });
        
        setPreviewImage(data.profilePicture || "/images/user/owner.jpg");
      }
    } catch (error) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: We typically do NOT send 'role' back for self-updates for security
          ...
          <form className="flex flex-col" onSubmit={handleSave}>
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="mb-6 flex flex-col items-center gap-3">
                ...
                <label className="cursor-pointer text-sm font-medium text-brand-500 hover:text-brand-600 hover:underline transition-colors">
                  Change Picture
                  <input 
                    type="file" 
                    className="hidden" 
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2">
                    <Label>Role </Label>
                    {/* Role is typically managed by Admins, not self-edited */}
                    <Input 
                      type="text" 
                      name="roleName" 
